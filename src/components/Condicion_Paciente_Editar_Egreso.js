import {
  ...
  export default function Condicion_Paciente_Editar_Egreso() {
     ...
     const {condicionpaciente, setcondicionpaciente,loading,setLoading,crear_condicionpaciente_ingreso,cargar_datos_condicionpaciente,modificar_condicionpaciente,alertacondicionpaciente} = useContext(condicionpacientecontext);
     ...
     const handleSubmit = async (e) => {
      e.preventDefault();
      setLoading(true);
      modificar_condicionpaciente(params.id_condicion); 
     };
     ...
     //cargo los datos de la condicion de ingreso
     useEffect(() => {
        if (params.id_condicion) {
           cargar_datos_condicionpaciente(params.id_condicion);
        }
      }, [params.dni]); //si cambia el dni se carga de nuevo
     ...
     useEffect(() => {
      if (paciente.id_paciente!=0 ) {
        ...
        condicionpaciente.id_ingreso=params.id_ingreso;
      }
           ...
           <Grid item xs={3}>
             ...
             >
               <Typography variant="5" textAlign="center" color="white">
                 Datos Condicion Egreso Paciente
               </Typography>
               <CardContent>
