...
export default function Condicion_Paciente_Form() {
   ...
   const {condicionpaciente, setcondicionpaciente,loading,setLoading,crear_condicionpaciente,alertacondicionpaciente} = useContext(condicionpacientecontext);
   ...
   const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    crear_condicionpaciente(condicionpaciente); 
   };
