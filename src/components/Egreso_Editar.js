import {
  ...
  export default function Egreso_Editar() {
    ...
    const{egreso,setegreso,modificar_egreso,loading,setLoading,limpiar_egreso,alertaegreso,cargar_datos_egreso} = useContext(egresocontext);
  ...
  //cancelo el refresh por defecto
    ...
    useEffect(() => {
      if (params.id_egreso) {
        cargar_datos_egreso(params.id_egreso);
        }
      }, [params.id_egreso]); //si cambia el dni se carga de nuevo
            ...
            <CardContent>
              <form onSubmit={handleSubmit}>
                ...
                <TextField
                  ...
                  type="date"
                  value={egreso.fecha_egreso.replace('T03:00:00.000Z','')}
